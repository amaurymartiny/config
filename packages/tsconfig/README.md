...
[![dependencies Status](https://david-dm.org/amaurymartiny/config/status.svg?path=packages/tsconfig)](https://david-dm.org/amaurymartiny/config?path=packages/tsconfig)
